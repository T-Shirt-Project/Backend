...
const { getProducts, getProductById, createProduct, updateProduct, deleteProduct, createProductReview, toggleLikeProduct, deleteProductReview, updateProductReview } = require('../controllers/productController');
...
router.route('/:id/reviews/:reviewId')
    ...
    .put(protect, admin, updateProductReview);
